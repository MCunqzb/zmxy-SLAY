...
public class BetterSpriterAnimation extends AbstractAnimation {
  ...
  public BetterSpriterAnimation(String filepath) {
    ...
    this.drawer = new BetterLibGdxDrawer((Loader)this.loader, this.renderer);
  ...
  public void renderSprite(SpriteBatch batch, float x, float y) {
    ...
    if (this.isDying) {
      this.color.lerp(this.targetColor, Gdx.graphics.getDeltaTime() * 3.0F);
  ...
  class BetterLibGdxDrawer extends Drawer<Sprite> {
