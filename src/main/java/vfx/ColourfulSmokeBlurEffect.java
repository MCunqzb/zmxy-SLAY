...
public class ColourfulSmokeBlurEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    private float aV;
    ...
    public ColourfulSmokeBlurEffect(float x, float y,float r1, float r2,float g1,float g2,float b1,float b2) {
