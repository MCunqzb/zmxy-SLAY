...
public class ColourfulHemokinesisParticle extends AbstractGameEffect {
    ...
    public  ColourfulHemokinesisParticle(float sX, float sY, float tX, float tY, boolean facingLeft, Color color) {
