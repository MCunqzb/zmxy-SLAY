...
public class ColorfulBloodShotParticleEffect extends AbstractGameEffect {
    private float sX;
    private float sY;
    private float tX;
    private float tY;
    ...
    public ColorfulBloodShotParticleEffect(float sX, float sY, float tX, float tY,Color color) {
        ...
        this.color = color;
        //new Color(MathUtils.random(0.2F, 0.5F), 0.1F, MathUtils.random(0.2F, 0.5F), 1.0F);
    }
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(this.img, this.x, this.y, (float)this.img.packedWidth / 2.0F, (float)this.img.packedHeight / 2.0F, (float)this.img.packedWidth, (float)this.img.packedHeight, this.scale * 4.0F, this.scale * 4.0F, this.rotation);
