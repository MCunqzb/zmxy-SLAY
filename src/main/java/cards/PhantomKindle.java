...
import powers.PhantomKindlePower;

public class PhantomKindle extends CustomCard {
    public static final String ID = "PhantomKindle";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new PhantomKindlePower(p,this.magicNumber)));
    }
    @Override
    public AbstractCard makeCopy() {
        return new PhantomKindle();
    }
