...
import actions.AllTagToHandAction;
...
public class BloodApeBoxing extends CustomCard {
    public static final String ID = "BloodApeBoxing";
    ...
    public static final String IMG_PATH = "img/cards/blood_ape_boxing.png";

    public BloodApeBoxing() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new AllTagToHandAction(MonkeyKingMod.BOXING));
