...
import powers.RampantBloodPower;

public class RampantBlood extends CustomCard {
    public static final String ID = "RampantBlood";
    ...
    public static final String IMG_PATH = "img/cards/rampant_blood.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new RampantBloodPower(p,this.magicNumber)));
    }
    @Override
    public AbstractCard makeCopy() {
        return new RampantBlood();
    }
