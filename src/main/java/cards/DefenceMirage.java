...
public class DefenceMirage extends CustomCard {
    public static final String ID = "DefenceMirage";
    ...
    public static final String IMG_PATH = "img/cards/defence_mirage.png";

    public DefenceMirage() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p,p,new DefenceMiragePower(p,this.magicNumber)));
    }
    @Override
    public AbstractCard makeCopy() {
        return new DefenceMirage();
    }
