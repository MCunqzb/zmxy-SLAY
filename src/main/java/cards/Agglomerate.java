...
import powers.AgglomeratePower;


public class Agglomerate extends CustomCard {
    public static final String ID = "Agglomerate";
    ...
    public static final String IMG_PATH = "img/cards/agglomerate.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new AgglomeratePower(p,this.magicNumber)));
    }
    @Override
    public AbstractCard makeCopy() {
        return new Agglomerate();
    }
